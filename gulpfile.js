...
const imgToApp = () => {
  return src(["./src/img/**/*.{jpg,jpeg,png,webp,svg}"]).pipe(
    dest("./app/img")
  );
};
...
exports.default = series(
  clean,
  parallel(htmlInclude, scripts, imgToApp, fontsToApp, svgSprites),
  styles,
  convertWebp,
  watchFiles
);
...
exports.build = series(
  clean,
  parallel(htmlInclude, scriptsBuild, imgToApp, fontsToApp, svgSprites),
  stylesBuild,
  imgMinifyBuild
);
